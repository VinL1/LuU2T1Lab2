public class ChatBot {
    ...
    // method that prints an apology
    public void sorry () {
        System.out.println ("Oh my god, I'm so sorry about that!");
        System.out.println ("I didn't realize it would happen this way.");
    }

    // method that returns the sum of three doubles
    public double addDoubles (double doub1, double doub2, double doub3) {
        return (doub1 + doub2 + doub3);
    }
}